...
;(function ($) {
  ...
  $.fn.panel = function (userConfig) {
    ...
    // Multiple elements?
    if (this.length > 1) {
      for (var i = 0; i < this.length; i++) $j(this[i]).panel(userConfig)
    ...
    if (typeof config.target != 'jQuery') config.target = $j(config.target)
  ...
  $.fn.placeholder = function () {
    ...
    // Multiple elements?
    if (this.length > 1) {
      for (var i = 0; i < this.length; i++) $j(this[i]).placeholder()
  ...
  $.prioritize = function ($elements, condition) {
    ...
    if (typeof $elements != 'jQuery') $elements = $j($elements)
